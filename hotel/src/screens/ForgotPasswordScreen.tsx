...
export function ForgotPasswordScreen({ navigation }: any) {
  ...
  return (
    <View className="flex-1 bg-[#020617]">
      <View
        className="absolute w-[400] h-[400] rounded-full bg-[#8083ff]/5 blur-[100px]"
      ...
      >
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="px-6 pt-20">
          ...
          <Text className="text-[#94a3b8] text-base mb-10">Enter your email and we'll send you instructions to reset your password.</Text>
          ...
          <View className="space-y-8">
            ...
            <TouchableOpacity onPress={() => navigation.navigate('login')} className="items-center">
                <Text className="text-[#94a3b8]">Back to <Text className="text-[#8083ff] font-bold">Sign In</Text></Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
